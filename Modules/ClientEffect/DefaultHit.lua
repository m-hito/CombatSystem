...
return function(argumentData: any)
	...
	if target and weaponUsed then
		...
		if rootPart then
			...
			if weaponUsed == "Fist" or weaponUsed == "FireFist" then
				--print("inside fist")

				local Clone = effects.CoreEffect[weaponUsed.."Effect"]:Clone()
			...
			elseif weaponUsed == "Katana" then
				--print("inside katana")

				local Clone = effects.CoreEffect[weaponUsed.."SlashEffect"]:Clone()
